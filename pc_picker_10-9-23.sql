...
--
-- Host: localhost
-- Generation Time: Oct 09, 2023 at 11:05 PM
...
(22, 'Intel® Core™ i7-13700H', 'NVIDIA® GeForce RTX™ 4050', '16 GB DDR5', '512 GB SSD', '17in'),
...
--
ALTER TABLE `laptop`
  MODIFY `laptop_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `laptop_partlist`
--
ALTER TABLE `laptop_partlist`
  MODIFY `laptop_pl_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
